---
title: "GoMx Gervais' beaked whale habitat models: Presence/absence with GAMs"
author: 
...
if (isempty(significantPvals_VisOnly)){
  disp("No significant predictors in visual only model!")
  disp("Recalculating model using predictor with lowest p value.")
  significantPvals_VisOnly<-which(VisOnlySummary$s.pv==min(VisOnlySummary$s.pv))
}
# rerun model with only significant predictors
