...
load('F:/GRIIDC_inputs/ModelData/Kspp/setup_info_Kspp.Rdata')
load('F:/GRIIDC_inputs/ModelData/Kspp/KsppMergedData.Rdata')
...
p1 <- ggplot() +
  geom_rect(data =VisOnly_predictionSet, aes(xmin=date[731], xmax=date[1095], ymin=0, ymax=50), fill="gray85")+
...
p2 <- ggplot() +
  ...
  geom_path(data = VisOnly_predictionSet,
            aes(x=date, y=GC, color = LegendTest),size = .5) +
  labs(y = " ", x = NULL)+coord_cartesian(ylim = c(0,50))+
...
p3 <- ggplot() +
  ...
  scale_color_manual(labels = c("Observations","Obs. (7-day smooth)","Model - Acoustic","Model - Visual"),
                     values= c("grey46","gray34","deepskyblue","red2"))+theme_bw()+
  labs(y =" ", x = NULL)+theme_bw()+coord_cartesian(ylim = c(0,50))+
