---
title: "GoMx pilot whale habitat models: Density with GAMs"
author: 
...
AcOnly_model <- gam_full_AcOnly[[AcOnly_model_index]]
AcOnly_model_name <- names(gam_full_AcOnly[AcOnly_model_index])
```
...
VisOnly_model <- gam_full_VisOnly[[VisOnly_model_index]]
VisOnly_model_name <- names(gam_full_VisOnly[VisOnly_model_index])
```
...
Joint_model <- gam_full_Joint[[Joint_model_index]]
Joint_model_name <- names(gam_full_Joint[Joint_model_index])
