...
load('F:/GRIIDC_inputs/ModelData/Gg/setup_info_Gg.Rdata')
load('F:/GRIIDC_inputs/ModelData/Gg/GgMergedData.Rdata')
...
histogram(Train_AcOnly.set$Density)
```
...
Vis_predictionSet$Legend1 <- "1 Observations"
...
p1 <- ggplot() +
  ...
  geom_line(data = Vis_predictionSet,
            aes(x=allTheDays, y=MC, color = LegendTest),size = .5,key_glyph = "rect") +
  labs(y = "", x = NULL)+coord_cartesian(ylim = c(0,50))+  theme_bw()+
  theme(legend.position=c(.90,.7),legend.title=element_blank(),
        legend.text = element_text(size = 8),axis.title.y = element_text(size = 8,),
        plot.margin = unit(c(0,0,8,9), "pt"),
...
p2 <- ggplot() +
  geom_rect(data =Vis_predictionSet, aes(xmin=allTheDays[731], xmax=allTheDays[1095], ymin=0, ymax=30), fill="gray85")+
  geom_col(data = Ac_predictionSet,
  ...
  geom_line(data = Vis_predictionSet,
            aes(x=allTheDays, y=GC, color = LegendTest),size = .5,key_glyph = "rect") +
  labs(y = "", x = NULL)+coord_cartesian(ylim = c(0,30))+  theme_bw()+
  scale_color_manual(labels = c("Observations","Obs. (7-day smooth)","Model - Acoustic","Model - Visual"),
                     values= c("grey46","gray34","deepskyblue","red2"),
                     guide = guide_legend(keyheight = unit(1, units = "mm") , keywidth = unit(2, units = "mm")))+
  theme(legend.position="none", axis.title.y = element_text(size = 8,),panel.spacing.y=unit(0, "lines"),plot.margin = unit(c(0,0,8,9), "pt"),axis.text.x = element_blank())+labs(y = "", x = NULL)+
  annotation_custom(gcLabel)


p3 <- ggplot() +
  geom_rect(data =Vis_predictionSet, aes(xmin=allTheDays[731], xmax=allTheDays[1095], ymin=0, ymax=120), fill="gray85")+
  geom_col(data = Ac_predictionSet,
  ...
  scale_color_manual(labels = c("Observations","Obs. (7-day smooth)","Model - Acoustic","Model - Visual"),
                     values= c("grey46","gray34","deepskyblue","red2"),
                     guide = guide_legend(keyheight = unit(1, units = "mm") , keywidth = unit(2, units = "mm")))+theme_bw()+labs(y=bquote("Density (per 1000"~km^2~")"),x=NULL)+
  theme(legend.position="none",axis.title.y = element_text(size = 8,),plot.margin = unit(c(0,0,8,0), "pt"),
        axis.text.x = element_blank())+
...
p4 <- ggplot() +
  ...
  geom_line(data = Ac_predictionSet,
             aes(x = allTheDays, y = DC_data_smooth, color = Legend), alpha = 1,width = .1,size = .25,key_glyph ="rect")+
  geom_line(data = Ac_predictionSet,
            aes(x=allTheDays, y=DC, color = LegendTest), size = .5) +
  geom_path(data = Vis_predictionSet,
            aes(x=allTheDays, y=DC, color = LegendTest),size = .5) +
  labs(y = "", x = NULL)+coord_cartesian(ylim = c(0,30))+
  scale_color_manual(labels = c("Observations","Obs. (7-day smooth)","Model - Acoustic","Model - Visual"),
                     values= c("grey46","gray34","deepskyblue","red2"),
                     guide = guide_legend(keyheight = unit(1, units = "mm") , keywidth = unit(2, units = "mm")))+theme_bw()+
  theme(legend.position="none",axis.title.y = element_text(size = 8,),plot.margin = unit(c(0,0,8,9), "pt"),
        axis.text.x = element_blank())+
...
p5 <- ggplot() +
  ...
  geom_line(data = Ac_predictionSet,
             aes(x = allTheDays, y = MP_data_smooth, color = Legend), alpha = 1,width = .1,size = .25,key_glyph ="rect")+
  geom_line(data = Ac_predictionSet,
  ...
  scale_color_manual(labels = c("Observations","Obs. (7-day smooth)","Model - Acoustic","Model - Visual"),
                     values= c("grey46","gray34","deepskyblue","red2"),
                     guide = guide_legend(keyheight = unit(1, units = "mm") , keywidth = unit(2, units = "mm")))+theme_bw()+
  theme(legend.position="none",axis.title.y = element_text(size = 8,),plot.margin = unit(c(0,0,-2,9), "pt"))+
  annotation_custom(mpLabel)
timeSeriesFig = paste(outDir,SP,'_Timeseries_Prediction_GAM_Density.png',sep='')
png(timeSeriesFig, width = 6.5, height = 6.7, units = "in", res=600)
...
png(paste(outDir,SP,'_summer2009maps_GAM_density.png',sep=''), width = 6, height = 4.5, units = 'in',res = 600)
...
july2009_AcOnly_prediction_plot <-july2009_AcOnly_prediction_crop
july2009_AcOnly_prediction_crop[july2009_AcOnly_prediction_crop>2.5]<-2.5
AcMapSummer = tm_shape(july2009_AcOnly_prediction_crop)+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",title = expression("Animals/100"~km^{2}),legend.reverse = TRUE)+ 
