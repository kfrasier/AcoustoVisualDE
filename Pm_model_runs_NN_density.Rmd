---
title: 'GoMx sperm whale habitat models: Density'
output: 
  html_document:
    toc: true
    toc_depth: 4
...
for (iM in 1:length(monthStr)){
  ...
  rasterImageFileName = paste0(savePath,'/Pm_climatology_predictions/', SP,'_',monthStr[iM],'NN_mean_encounter_probability.tif')
