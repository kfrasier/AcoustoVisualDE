...
#   2014.12.23  Yibo Jiang, version 3 (Modified to be more general including most L3 and L4 datasets with netCDF format)
#   2017.06.21  Yibo Jiang, version 4 (Fix for MODIS L3 datasets)
