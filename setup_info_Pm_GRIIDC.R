...
acousticDensityFile <-"F:/NASData/ModelData/Pm/MC_GC_DT_binsize_clickDensity_Pm3.csv" # acoustic input file"F:/NASData/ALLSITES_binsize000800_Gg_density_jahStart.csv"# 
# The name of the acoustic density file with matched segments
acDensityFile <- paste0('ACDensity_Segments_',SP,'.Rdata')
# pOccurenceFile <- 'F:/NASData/ModelData/Pm/ALLSITES_weeklyPOccurrence_Pm_jahStart.csv' # percent ofdays/week they were present 
