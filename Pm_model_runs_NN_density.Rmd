...
# par(mfrow = c(5,1),oma=c(3,0,5,0)),colour="#000099",colour="#CC0000"
p1 <- ggplot() +
  geom_rect(data =VisOnly_predictionSet, aes(xmin=date[731], xmax=date[1095], ymin=0, ymax=25), fill="gray85")+
  geom_col(data = AcOnly_predictionSet,
...
p2 <- ggplot() +
  ...
  scale_color_manual(values= c("grey36","green3","deepskyblue"))+theme_bw()+
  theme(legend.position="none", axis.title.y = element_text(size = 8,),panel.spacing.y=unit(0, "lines"),plot.margin = unit(c(0,0,10,8), "pt"),axis.text.x = element_blank())+
...
p3 <- ggplot() +
  ...
  labs(y =" ", x = NULL)+theme_bw()+coord_cartesian(ylim = c(0,25))+
