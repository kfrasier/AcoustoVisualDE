...
```{r Set up parallel cluster, echo = FALSE}
numCores <- detectCores() - 1
cl <-makeCluster(numCores)
```

```{r Ac. only Model, results = 'hide', message = FALSE, eval = TRUE, echo = FALSE}
AcCounter <- 0
...
```{r other models, eval = TRUE, echo = FALSE} 
## VISUAL ONLY
modelCounter <- 0
# put together the formula
...
```{r Turn off parallel cluster, echo = FALSE}
stopCluster(cl)
```
<br>  
