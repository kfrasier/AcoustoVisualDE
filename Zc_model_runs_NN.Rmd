...
```{r map inputs, Warning = TRUE, echo = FALSE}
...
```{r correlation plots, eval = TRUE, message = FALSE, Warning = TRUE, results = 'hide', echo = FALSE}
...
```{r,fig.height = 10, fig.width = 7, message = FALSE, Warning = TRUE, echo = FALSE}
...
```{r Combo Temporal Predict,fig.height = 10, fig.width = 7, Warning = TRUE, echo = FALSE}
...
```{r Ac Spatial Predict, Warning = TRUE, echo = FALSE}
...
```{r Vis Spatial Predict, Warning = TRUE, echo = FALSE}
...
```{r Combo Spatial Predict, Warning = TRUE, echo = FALSE}
...
```{r wrangle projections, message = FALSE, Warning = TRUE, echo = FALSE, results = 'hide'}
...
```{r Model Averaging, Warning = TRUE, echo = FALSE}
### Model averaging 
...
```{r leaflet summer, message = FALSE, Warning = TRUE, echo = FALSE}
...
```{r leaflet winter, message = FALSE, Warning = TRUE, echo = FALSE}
...
```{r evaluate climatology-based models, echo = FALSE, message = FALSE, Warning = TRUE}
...
```{r plot climatologies, message = FALSE, Warning = TRUE, echo = FALSE}
pal <- colorNumeric(palette = matlab.like2(5),
                    domain=c(0,1), 
                    na.color = 'transparent')
