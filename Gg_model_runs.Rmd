...
Visual data goes back to 1992, but many predictor variables are only available starting in 2003, therefore earlier visual data is currently excluded from further analyses.
![VisDataAvail](E:/NASData/ModelData/Gg/VisualOnly_Gg_missingData.png)
...
![Gg_MC](E:/NASData/ModelData/Gg/Gg_Timeseries_Site_MC.png)
![Gg_GC](E:/NASData/ModelData/Gg/Gg_Timeseries_Site_GC.png)
![Gg_DT](E:/NASData/ModelData/Gg/Gg_Timeseries_Site_DT.png)
![Gg_DC](E:/NASData/ModelData/Gg/Gg_Timeseries_Site_DC.png)
![Gg_MP](E:/NASData/ModelData/Gg/Gg_Timeseries_Site_MP.png)
...
![AcDataDots](E:/NASData/ModelData/Gg/AcousticOnly_Gg_clevelandDots_noTransform.png)



Here are the distributions of covariates from the visual observations:
![VisDataDots](E:/NASData/ModelData/Gg/VisualOnly_Gg_clevelandDots_noTransform.png)

Some of these covariates are more or less interrelated. Numbers closer to 1 above the diagonal in the figure below represent correlation coefficients. Highly correlated covariates should not be used together in the same model. 
![corrNoTransform](E:/NASData/ModelData/Gg/Gg_correlations_noTransform.png)
...
![BothDataDots](E:/NASData/ModelData/Gg/AcousticAndVisual_Gg_clevelandDots_withTransform.png)
...
Acoustic data
![AcDataDensity](E:/NASData/ModelData/Gg/VisualOnly_Gg_density_pres_abs.png)


Visual data
![VisDataDensity](E:/NASData/ModelData/Gg/VisualOnly_Gg_density_pres_abs.png)
...
```{r AC model 1, eval = FALSE, echo=FALSE} 
...
```{r AC model 2, eval = FALSE, echo = FALSE}
...
```{r AC model 3, eval = FALSE, echo = FALSE}
...
```{r AC model 4, eval = FALSE, echo = FALSE}
...
```{r AC model 5, eval = FALSE, echo = FALSE}
...
```{r AC model 6, eval = FALSE, echo = FALSE}
...
```{r AC model 7, eval = FALSE, echo = FALSE}
...
```{r AC model 8, eval = FALSE, echo = FALSE}
...
```{r AC model 9, eval = FALSE, echo = FALSE}
...
```{r AC model 10, eval = FALSE, echo = FALSE}
...
```{r AC model 11, eval = FALSE, echo = FALSE}
...
```{r AC model 12, eval = FALSE, echo = FALSE}
...
```{r AC model 13, eval = FALSE, echo = FALSE}
...
```{r AC model 14, eval = FALSE, echo = FALSE}
...
```{r AC model 15, eval = FALSE, echo = FALSE}
...
twoord.plot(Test_AcOnly.set$date[compAcSet_GC],predAcOnly_GC,
            ...
            xtickpos =dateTicks,xticklab = rep('',5),mar = c(1, 5, 0, 5),lytickpos = c(0,.1,.2,.3),
            rytickpos = c(0,.03,.06,.09), lylim= c(0,.4), rylim= c(0,.1))
