---
title: 'GoMx sperm whale habitat models: GAMs'
output: 
  html_document:
    toc: true
    toc_depth: 4
...
load("E:/NASData/ModelData/Pm/PmsightwTrunc_GU.Rdata")
visDetProb <- detFun[[bestModelIdx]]$fitted[1]
...
for (iM in 1:length(monthStr)){
  ...
  rasterImageFileName = paste0(savePath,'/Pm_climatology_predictions/', SP,'_',monthStr[iM],'GAM_mean_encounter_probability.tif')
