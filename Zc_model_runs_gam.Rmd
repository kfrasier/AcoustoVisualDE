...
```{r other models 2, eval = FALSE, include = TRUE} 
...
```{r other models 3, eval = FALSE, include = TRUE} 
...
```{r Other models 4, eval = FALSE, include = TRUE}
...
```{r evaluate climatology-based models, eval = FALSE, message = FALSE, warning = FALSE}
...
```{r plot climatologies, eval = FALSE, message = FALSE, warning = FALSE}
pal <- colorNumeric(palette = matlab.like2(5),
                    domain=c(0,1), 
                    na.color = 'transparent')
