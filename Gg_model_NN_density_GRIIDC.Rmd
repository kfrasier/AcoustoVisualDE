...
p4 <- ggplot() +
  ...
  scale_color_manual(labels = c("Observations","Obs. (7-day smooth)","Model - Acoustic","Model - Visual"),
                     values= c("grey46","gray34","deepskyblue","red2"))+theme_bw()+
  theme(legend.position="none",axis.title.y = element_text(size = 8,),plot.margin = unit(c(0,0,10,9),"pt"),axis.text.x = element_blank())+coord_cartesian(ylim = c(0,40))+labs(y = " ")+
