...
# these are going to be scaled, but in case density ranges are very different between the two methods, I want them to be scaled separately by method.
transformedCovars.train$y <-c(scale(transformedCovars_AcOnly.train$yAcOnly,
                              center = TRUE, scale = TRUE),
                              scale(transformedCovars_VisOnly.train$yVisOnly, 
                              center = TRUE, scale = TRUE))
...
transformedCovars.test$y <-c(scale(transformedCovars_AcOnly.test$yAcOnly,
                              center = TRUE, scale = TRUE),
                              scale(transformedCovars_VisOnly.test$yVisOnly, 
                              center = TRUE, scale = TRUE))
