---
title: 'Stenellid dolphin habitat models: Neural Net'
output: 
  html_document:
    toc: true
    toc_depth: 4
...
```{r Ac. Only Model 2, results = 'hide', message = FALSE, eval = TRUE, echo = FALSE}
...
```{r other models 2, eval = TRUE, echo = FALSE} 
## VISUAL ONLY
...
```{r Ac Only Model 3, results = 'hide', message = FALSE, eval = TRUE, echo = FALSE}
...
```{r other models 3, eval = TRUE, echo = FALSE} 
## Vis Only
