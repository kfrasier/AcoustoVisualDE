...
The visual data represent wether or not `r SPLong` were seen during each transect segment. The probability of missing a sighting of risso's dolphin was estimated as 
\[P_{V}(detect|present) = \mu_{det} * g0\ =  `r visDetProb` * `r visG0` = `r (visDetProb*visG0)`\]
