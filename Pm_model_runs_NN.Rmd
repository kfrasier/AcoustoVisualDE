...
* Acoustic data have a trucation distance  of 7 km for sperm whales (95% of group detections occur within this range), for a total monitoring area of $(7 km)^{2} \pi$, 
...
* Visual trucation distance for sperm whales is estimated as 6.8 km (see figure below) from these data. ESW is multiplied by transect segment length (usually ~10 km) and doubled to estimate total area swept.


<br>  

\[\text{Acoustic to Visual ratio} = \frac{24 hrs \cdot (7 km)^{2} \pi}{(\text{Segment length}/18.52 km/hr) \cdot 6.8 km \cdot \text{Segment length} \cdot 2} = 3694.51/73.44 \approx 50.31:1
\]
...
cat(paste0('Mean visual data point weight: ', 
           round(mean(Train_VisOnly.set$Weight/Train_VisOnly.set$Weight)), 
           '\nAcoustic data point weight: ',
           round(mean(Train_AcOnly.set$Weight/Train_VisOnly.set$Weight))))
```
