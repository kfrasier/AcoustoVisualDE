---
title: 'Risso''s dolphin habitat models: Neural Net'
output: 
  html_document:
    toc: true
    toc_depth: 4
...
```{r Ac. only Model 1, results = 'hide', message = FALSE, eval = FALSE, include = FALSE}
...
```{r Ac. Only Model 2, results = 'hide', message = FALSE, eval = FALSE, include = FALSE}
...
```{r other models 2, eval = FALSE, include = FALSE} 
## VISUAL ONLY
...
```{r Ac Only Model 3, results = 'hide', message = FALSE, eval = FALSE, include = FALSE}
...
```{r other models 3, eval = FALSE, include = FALSE} 
## Vis Only
