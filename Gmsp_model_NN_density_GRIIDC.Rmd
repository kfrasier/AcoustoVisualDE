...
load('F:/GRIIDC_inputs/ModelData/Gmsp/setup_info_Gmsp.Rdata')
load('F:/GRIIDC_inputs/ModelData/Gmsp/GmspMergedData.Rdata')
...
p1 <- ggplot() +
  geom_rect(data =VisOnly_predictionSet, aes(xmin=date[731], xmax=date[1095], ymin=0, ymax=100), fill="gray85")+
...
p2 <- ggplot() +
  ...
  geom_path(data = VisOnly_predictionSet,
            aes(x=date, y=GC, color = LegendTest),size = .5) +
  labs(y = " ", x = NULL)+coord_cartesian(ylim = c(0,100))+
...
p3 <- ggplot() +
  ...
  scale_color_manual(labels = c("Observations","Obs. (7-day smooth)","Model - Acoustic","Model - Visual"),
                     values= c("grey46","gray34","deepskyblue","red2"))+theme_bw()+
  labs(y =" ", x = NULL)+theme_bw()+coord_cartesian(ylim = c(0,100))+
...
p4 <- ggplot() +
  ...
  scale_color_manual(labels = c("Observations","Obs. (7-day smooth)","Model - Acoustic","Model - Visual"),
                     values= c("grey46","gray34","deepskyblue","red2"))+theme_bw()+
  theme(legend.position="none",axis.title.y = element_text(size = 8,),plot.margin = unit(c(0,0,10,9),"pt"),axis.text.x = element_blank())+coord_cartesian(ylim = c(0,100))+labs(y = " ")+
...
p5 <- ggplot() +
  ...
  scale_color_manual(labels = c("Observations","Obs. (7-day smooth)","Model - Acoustic","Model - Visual"),
                     values= c("grey46","gray34","deepskyblue","red2"))+theme_bw()+
  theme(legend.position="none",axis.title.y = element_text(size = 8,),plot.margin = unit(c(0,0,0,9),"pt"))+coord_cartesian(ylim = c(0,100))+
