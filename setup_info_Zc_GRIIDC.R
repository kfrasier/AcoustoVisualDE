...
acousticDensityFile <-"F:/NASData/ModelData/Zc/MC_GC_DT_binsize011000_Group_density3_Cuviers.csv" # acoustic input file"F:/NASData/ALLSITES_binsize000800_Gg_density_jahStart.csv"# 
# The name of the acoustic density file with matched segments
acDensityFile <- paste0('ACDensity_Segments_',SP,'.Rdata')
# pOccurenceFile <- 'F:/NASData/ModelData/Zc/ALLSITES_weeklyPOccurrence_Zc_jahStart.csv' # percent ofdays/week they were present 
