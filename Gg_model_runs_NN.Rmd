...
best_AcOnly_ModelIndex <-which.min(XEntropy_unweighted$AcOnly_test_JointData)
print(paste(c('Best acoustic model has', layerSizeList[best_AcOnly_ModelIndex], 
              'nodes.'),collapse = " "))
best_VisOnly_ModelIndex <-which.min(XEntropy_unweighted$VisOnly_test_JointData)
print(paste(c('Best visual model has', layerSizeList[best_VisOnly_ModelIndex],
            'nodes.'),collapse = " "))
best_Joint_ModelIndex <-which.min(XEntropy_unweighted$Joint_test)
