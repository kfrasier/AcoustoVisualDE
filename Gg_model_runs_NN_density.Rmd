...
Models were compared using mean average error (MAE) to compare predicted and observed presence/absence in the test data.
...
MSE$nn_AcOnly_test_allData[[modelCounter]] <- mean(Joint_test_scaled$weightsG0*
                             abs(covars_Joint_max.train['y']*(Joint_test_scaled$y -   
...
MSE$nn_Joint_test_allData[[modelCounter]] <- mean(Joint_test_scaled$weightsG0*
                             abs(covars_Joint_max.train['y']*(Joint_test_scaled$y -
...
MSEtable<- rbind(MSE$nn_AcOnly_train,MSE$nn_AcOnly_test,MSE$nn_VisOnly_train,
                 MSE$nn_VisOnly_test,MSE$nn_Joint_train,MSE$nn_Joint_test_allData,
...
JointMapSummer = tm_shape(july2009mean_prediction_crop)+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,title = "Animals/100 km^{2}")

AcMapSummer = tm_shape(july2009_AcOnly_prediction_crop)+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,title = "Animals/100 km^{2}")

VisMapSummer = tm_shape(july2009_VisOnly_prediction_crop)+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,title = "Animals/100 km^{2}")
 tmap_arrange(AcMapSummer,VisMapSummer,JointMapSummer)
```
