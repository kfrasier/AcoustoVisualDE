---
title: "GoMx pilot whale  habitat models: Density with neural nets"
author: 
...
MSEtable<- rbind(MAE$nn_AcOnly_test_allData,MAE$nn_VisOnly_test_allDat,aMAE$nn_Joint_test_allData)
colnames(MSEtable)<- layerSizeList
rownames(MSEtable)<- c("Acoustic - Train","Acoustic - Test",
                       "Visual - Train","Visual - Test",
                       "Joint - Train",
                       "Acoustic - Joint test data","Visual - Joint test data","Joint - Test",)
