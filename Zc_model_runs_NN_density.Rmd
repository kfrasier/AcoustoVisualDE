...
tiff(paste(outDir,SP,'_AcOnly_exampleNetwork.tiff',sep=''), res = 300,width = 4.75, height = 4, units = "in")
...
dev.off()
egNetFig <-paste0(outDir,SP,'_AcOnly_exampleNetwork.tiff')
```
***Example network:***
...
AcOnly_predictionSet$obs_MC_smooth[m1]<- rollmean(allCovars$observations[compAcSet_MC_all],k = 7,fill=NA)
