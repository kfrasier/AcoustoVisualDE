---
title: "GoMx Cuvier's beaked whale habitat models: Density with neural nets"
author: 
...
outDir <- file.path('E:/NASData/ModelData',SP,'norm_exp//')
...
covars_Joint_mean.train <- apply(Joint.train.NoNa, 2, mean, na.rm = TRUE) 
covars_Joint_std.train <- apply(Joint.train.NoNa, 2, std) 
yCenter<- covars_Joint_mean.train[[1]]
yScale<- (covars_Joint_max.train[[1]]-covars_Joint_min.train[[1]])/2

Joint_train_scaled <- as.data.frame(scale(Joint.train.NoNa, 
                        center = covars_Joint_mean.train, 
                        scale = (covars_Joint_max.train-covars_Joint_min.train)/2))
Joint_train_scaled$y <- Joint_train_scaled$Density #Joint.train.NoNa$y/covars_Joint_max.train['y']
...
AcOnly_train_scaled <- as.data.frame(scale(AcOnly.train.NoNa, 
                          center = covars_Joint_mean.train, 
                        scale = (covars_Joint_max.train-covars_Joint_min.train)/2))
#AcOnly_train_scaled$yAcOnly <- AcOnly_train_scaled$Density AcOnly.train.NoNa$yAcOnly/covars_Joint_max.train['y']
...
VisOnly_train_scaled <- as.data.frame(scale(VisOnly.train.NoNa, 
                          center = covars_Joint_mean.train, 
                        scale = (covars_Joint_max.train-covars_Joint_min.train)/2))
#VisOnly_train_scaled$yVisOnly <- VisOnly_train_scaled$Density VisOnly.train.NoNa$yVisOnly/covars_Joint_max.train['y']
...
VisOnly_test_scaled <- as.data.frame(scale(VisOnly.test.NoNa, 
                        center = covars_Joint_mean.train, 
                        scale = (covars_Joint_max.train-covars_Joint_min.train)/2))
VisOnly_test_scaled$yVisOnly <- VisOnly_test_scaled$Density #VisOnly.test.NoNa$yVisOnly/covars_Joint_max.train['y']
...
Joint_test_scaled <- as.data.frame(scale(Joint.test.NoNa, 
                        center = covars_Joint_mean.train, 
                        scale = (covars_Joint_max.train - covars_Joint_min.train)/2))
Joint_test_scaled$y <- Joint_test_scaled$Density #Joint.test.NoNa$y/covars_Joint_max.train['y']
...
for (layerSize in layerSizeList){
  ...
  MSE$nn_AcOnly_train[[AcCounter]] <- mean(abs((AcOnly_train_scaled$yAcOnly - 
                                    pr$nn_AcOnly_train[[AcCounter]])*yScale+yCenter),na.rm = TRUE)
  ...
  MSE$nn_AcOnly_test[[AcCounter]] <- mean(abs((AcOnly_test_scaled$yAcOnly - 
                                    pr$nn_AcOnly_test[[AcCounter]])*yScale+yCenter),na.rm = TRUE)
  ...
  MSE$nn_AcOnly_test_allData[[AcCounter]] <- mean(abs(Joint_test_scaled$weightsG0*
               (((Joint_test_scaled$y - pr$nn_AcOnly_test_allData[[AcCounter]])*yScale)+yCenter)), na.rm = TRUE)
...
RMSE$nn_VisOnly_test_allData[[modelCounter]] <- sqrt(mean(Joint_test_scaled$weightsG0*
               (((Joint_test_scaled$y - pr$nn_VisOnly_test_allData[[modelCounter]])*yScale)+yCenter)^2,
               na.rm = TRUE))
...
wRMSE$nn_AcOnly_test_allData[[modelCounter]] <-  sqrt(mean(Joint_test_scaled$weightsG0*
               (((Joint_test_scaled$y - pr$nn_AcOnly_test_allData[[modelCounter]])*yScale)+yCenter)^2,
               na.rm = TRUE))
...
wRMSE$nn_Joint_test_allData[[modelCounter]] <-  sqrt(mean(Joint_test_scaled$weightsG0*
               (((Joint_test_scaled$y - pr$nn_Joint_test_allData[[modelCounter]])*yScale)+yCenter)^2,
               na.rm = TRUE))
}
...
tiff(paste(outDir,SP,'_exampleNetwork.tiff',sep=''), res = 300,width = 4.75, height = 4, units = "in")
par(mar=c(1,0,1,0),family = 'serif')
NNFitVals <- NULL
...
predVar_GC <- NULL
predVar_DT <- NULL
myYmax <- 25#ceiling(max(c(predAcOnly_MC,predAcOnly_GC,predAcOnly_DT),na.rm = TRUE))
...
# myYmax <- ceiling(max(c(predVisOnly_MC,predVisOnly_GC,predVisOnly_DT),na.rm = TRUE))
...
#myYmax <- 20# ceiling(max(c(pred_MC,pred_GC,pred_DT),na.rm = TRUE))
...
p2 <- ggplot() +
  ...
  # geom_path(data = AcOnly_predictionSet,
  #            aes(x = date, y = obs_GC_smooth),color ="black",alpha = .5,size = .25)+
  geom_line(data = AcOnly_predictionSet,
...
p3 <- ggplot() +
  ...
  labs(y = "", x = NULL)+theme_bw()+coord_cartesian(ylim = c(0,myYmax))+
  theme(legend.position="none",axis.title.y = element_text(size = 8,))+
  annotation_custom(dtLabel)

png(paste(outDir,SP,'_Joint_Timeseries_Prediction_NN_Density.png',sep=''), width = 6.6, height = 4, units = "in", res=600)
...
predSTD_jan2009_Joint_crop <- calc(stack(perModel_jan2009_Joint_crop),fun=std_err,na.rm=TRUE)/10
...
crop_limits_Reproj = spTransform(crop_limits_proj,crs(GU2009EffortLines))
maxColorSummer = 1.5
JointMap1 = tm_shape(july2009_prediction_hidden[[1]])+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,title = expression("Animals/100"~km^{2}),legend.reverse = TRUE)+ tm_layout(panel.labels="4 Nodes",panel.label.size=.6,legend.position = c(0.76,0.35))+
  tm_shape(crop_limits_Reproj)+
  tm_borders(lty = 1)+
  tm_shape(GU2009EffortLines)+tm_lines()+
  tm_shape(harpShape)+tm_symbols(col = "orange", border.col = "black",size = 0.3, alpha = 1,shape = 24)+
...
JointMap2 = tm_shape(july2009_prediction_hidden[[2]])+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,legend.show = FALSE)+ tm_layout(panel.labels="6 Nodes",panel.label.size=.6)+
  tm_shape(crop_limits_Reproj)+
  tm_borders(lty = 1)+
  tm_shape(GU2009EffortLines)+tm_lines()+
...
JointMap3 = tm_shape(july2009_prediction_hidden[[3]])+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,legend.show = FALSE)+ tm_layout(panel.labels="8 Nodes",panel.label.size=.6,legend.position = c(0.89,0.02))+
  tm_shape(crop_limits_Reproj)+
  tm_borders(lty = 1)+
  tm_shape(GU2009EffortLines)+tm_lines()+
  tm_shape(harpShape)+tm_symbols(col = "orange", border.col = "black",size = 0.2, alpha = 1,shape = 24)+
...
JointMap4 = tm_shape(july2009_prediction_hidden[[4]])+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,legend.show = FALSE)+ tm_layout(panel.labels="10 Nodes",panel.label.size=.6)+
  tm_shape(crop_limits_Reproj)+
  tm_borders(lty = 1)+
  tm_shape(GU2009EffortLines)+tm_lines()+
  tm_shape(harpShape)+tm_symbols(col = "orange", border.col = "black",size = 0.2, alpha = 1,shape = 24)+
...
JointMap5 = tm_shape(july2009_prediction_hidden[[5]])+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,legend.show = FALSE)+ tm_layout(panel.labels="12 Nodes",panel.label.size=.6)+
  tm_shape(crop_limits_Reproj)+
  tm_borders(lty = 1)+
  tm_shape(GU2009EffortLines)+tm_lines()+
  tm_shape(harpShape)+tm_symbols(col = "orange", border.col = "black",size = 0.2, alpha = 1,shape = 24)+
...
JointMap6 = tm_shape(july2009_prediction_hidden[[6]])+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,legend.show = FALSE)+ tm_layout(panel.labels="14 Nodes",panel.label.size=.6)+
  tm_shape(crop_limits_Reproj)+
  tm_borders(lty = 1)+
  tm_shape(GU2009EffortLines)+tm_lines()+
  tm_shape(harpShape)+tm_symbols(col = "orange", border.col = "black",size = 0.2, alpha = 1,shape = 24)+
