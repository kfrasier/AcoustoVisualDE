...
#myList =  c("Ssp_model_runs_gam.Rmd", "Pm_model_runs_gam.Rmd")# "Gmsp_model_runs_gam.Rmd", "Zc_model_runs_gam.Rmd", ""Kspp_model_runs_gam.Rmd", Gg_model_runs_gam.Rmd" "Me_model_runs_gam.Rmd",
 ...
 #             "Kspp_model_runs_gam_density.Rmd")#"Gg_model_runs_gam_density.Rmd","Me_model_runs_gam_density.Rmd",
 #  
 # myList =  c( "Gmsp_model_runs_NN_density.Rmd", "Gg_model_runs_NN_density.Rmd",
