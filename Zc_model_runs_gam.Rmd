---
title: 'GoMx Cuvier''s beaked whale habitat models: GAMs'
output: 
  html_document:
    toc: true
    toc_depth: 4
...
The visual data represent wether or not  Cuvier's beaked whales were seen during each transect segment. The probability of missing a sighting of risso's dolphin was estimated as 
...
predJoint_MC <- predict.gam(best_Joint_model,
                             transformedCovars.test[compAcSet_MC,],
                             type = 'response',na.action = na.pass,se.fit=TRUE)
predJoint_GC <- predict.gam(best_Joint_model,
                             transformedCovars.test[compAcSet_GC,],
                             type = 'response',na.action = na.pass,se.fit=TRUE)
predJoint_DT <- predict.gam(best_Joint_model,
                             transformedCovars.test[compAcSet_DT,],
                             type = 'response',na.action = na.pass,se.fit=TRUE)
