...
The visual data represent wether or not `r I(SPLong)` were seen during each transect segment. The probability of missing a sighting of risso's dolphin was estimated as 
...
for (layerSize in layerSizeList){
  ...
  MSE.nn_Joint_test[[modelCounter]]  <- sum(Joint_test_scaled$weightsG0*(Joint_test_scaled$y - 
...
p1_Ac <- ggplot() +
  ...
  geom_line(data = AcOnly_predictionSet,
             aes(x = date, y = testObs_MC,color = Legend1))+
  geom_line(data = AcOnly_predictionSet,
...
p2_Ac <- ggplot() +
  ...
  geom_line(data = AcOnly_predictionSet,
             aes(x = date, y = testObs_GC,color = Legend1))+
  geom_line(data = AcOnly_predictionSet,
...
p3_Ac <- ggplot() +
  ...
  geom_line(data = AcOnly_predictionSet,
             aes(x = date, y = testObs_DT,color = Legend1))+
  geom_line(data = AcOnly_predictionSet,
...
p4_Ac <- ggplot() +
  ...
  geom_line(data = AcOnly_predictionSet,
             aes(x = date, y = testObs_DC,color = Legend1))+
  geom_line(data = AcOnly_predictionSet,
...
p5_Ac <- ggplot() +
  ...
  geom_line(data = AcOnly_predictionSet,
             aes(x = date, y = testObs_MP,color = Legend1))+
  geom_line(data = AcOnly_predictionSet,
