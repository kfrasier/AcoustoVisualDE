...
for (iM in 1: length(nn_AcOnly)){
  XEntropy$AcOnly_train[[iM]] <- LogLoss(round(pr$nn_AcOnly_train[[iM]],digits = 0),
                                         AcOnly_train_scaled$yAcOnly_TF)
  XEntropy$AcOnly_test[[iM]] <- LogLoss(round(pr$nn_AcOnly_test[[iM]],digits = 0),
                                        AcOnly_test_scaled$yAcOnly_TF)
  XEntropy$AcOnly_test_JointData[[iM]] <- weighted_logloss(round(pr$nn_AcOnly_test_JointData[[iM]],digits = 0),
  ...
  XEntropy$VisOnly_test_JointData[[iM]] <- weighted_logloss(round(pr$nn_VisOnly_test_JointData[[iM]],digits = 0),
                                        Joint_test_scaled$y_TF,
                                        Joint_test_scaled$weightsG0)
  ...
  XEntropy_unweighted$Joint_test[[iM]] <- LogLoss(round(pr$nn_Joint_test[[iM]], digits = 0),
                                         Joint_test_scaled$y_TF)
...
KSStat <- NULL
for (iM in 1: length(nn_AcOnly)){
  KSStat$AcOnly_train[[iM]] <- KS_Stat(round(pr$nn_AcOnly_train[[iM]],digits = 0),
                                       AcOnly_train_scaled$yAcOnly_TF)
  KSStat$AcOnly_test[[iM]] <- KS_Stat(round(pr$nn_AcOnly_test[[iM]],digits = 0),
                                      AcOnly_test_scaled$yAcOnly_TF)
  KSStat$VisOnly_train[[iM]] <- KS_Stat(round(pr$nn_VisOnly_train[[iM]],digits = 0),
                                        VisOnly_train_scaled$yVisOnly_TF)
  KSStat$VisOnly_test[[iM]] <- KS_Stat(round(pr$nn_VisOnly_test[[iM]],digits = 0),
                                       VisOnly_test_scaled$yVisOnly_TF)
  KSStat$Joint_train[[iM]] <- KS_Stat(round(pr$nn_Joint_train[[iM]],digits = 0),
                                      Joint_train_scaled$y_TF)
  KSStat$Joint_test[[iM]] <- KS_Stat(round(pr$nn_Joint_test[[iM]],digits = 0),
                                     Joint_test_scaled$y_TF)
}
...
JointMapSummer = tm_shape(july2009_prediction_crop)+
  tm_raster(palette = viridis(9, begin = 0,end = max(july2009_prediction_crop@data@values,
            na.rm = TRUE)/maxColorSummer),
            colorNA = NULL,style = "cont",
            title = "P(Encounter)",legend.reverse = TRUE)+ 
...
AcMapSummer = tm_shape(july2009_AcOnly_prediction_crop)+
  tm_raster(palette = viridis(9, begin = 0,end = max(july2009_AcOnly_prediction_crop@data@values,
            na.rm = TRUE)/maxColorSummer),colorNA = NULL,style = "cont",
            title = "P(Encounter)",legend.reverse = TRUE)+ 
...
VisMapSummer = tm_shape(july2009_VisOnly_prediction_crop)+
  tm_raster(palette = viridis(9, begin = 0,end = max(july2009_VisOnly_prediction_crop@data@values,
            na.rm = TRUE)/maxColorSummer),colorNA = NULL,style = "cont",
            title = "P(Encounter)",legend.reverse = TRUE)+ 
  tm_layout(legend.title.size = .9,legend.position = c(.8,.50))+
  tm_shape(crop_limits_Reproj)+tm_borders(lty = 1)+
