...
par(mar = c(5.1, 4.1, 4.1, 3.1))
plot.nnet(nn_AcOnly[[best_AcOnly_ModelIndex]]$model[[1]],x.lab = n2, y.lab = "P(encounter)",bias = F,cex.val=1)
dev.off()

png(paste(outDir,SP,'_exampleNetwork_VisOnly_PresAbs.png',sep=''), width = 1200, height = 600)
par(mar = c(5.1, 4.1, 4.1, 3.1))
plot.nnet(nn_VisOnly[[best_VisOnly_ModelIndex]]$model[[1]],x.lab = n2, y.lab = "P(encounter)",bias = F,cex.val=1)
dev.off()
...
tiff(paste(outDir,SP,'_exampleNetwork_Joint_presAbs.tiff',sep=''), res = 300,width = 4, height = 4, units = "in")
...
plot.nnet(nn_Joint[[best_Joint_ModelIndex]]$model[[bestNetwork]],x.lab = n3, y.lab = "P(E)",bias = F,cex=1.4,circle.col='lightskyblue1', node.labs = FALSE,circle.cex = 3, alpha.val =.8)
dev.off()
...
JointMap3 = tm_shape(july2009_prediction_hidden[[4]])+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,legend.show = FALSE)+ tm_layout(panel.labels="8 Nodes",panel.label.size=.6)+
  tm_shape(crop_limits_Reproj)+
  tm_borders(lty = 1)+
  tm_shape(GU2009EffortLines)+tm_lines()+
  tm_shape(harpShape)+tm_symbols(col = "orange", border.col = "black",size = 0.2, alpha = 1,shape = 24)+
...
JointMap4 = tm_shape(july2009_prediction_hidden[[1]])+tm_raster(palette = matlab.like2(5),colorNA = NULL,style = "cont",midpoint = maxColorSummer/2,legend.show = FALSE)+ tm_layout(panel.labels="10 Nodes",panel.label.size=.6)+
  tm_shape(crop_limits_Reproj)+
  tm_borders(lty = 1)+
  tm_shape(GU2009EffortLines)+tm_lines()+
  tm_shape(harpShape)+tm_symbols(col = "orange", border.col = "black",size = 0.2, alpha = 1,shape = 24)+
