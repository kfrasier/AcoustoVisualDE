...
outDir <- file.path('E:/NASData/ModelData',SP,'10000//')
...
AcOnly_predictionSet$obs_DC_smooth[m4]<- allCovars$observations_smooth[compAcSet_DC_all]
...
AcOnly_predictionSet$obs_MP_smooth[m5]<- allCovars$observations_smooth[compAcSet_MP_all]
...
p1 <- ggplot() +
  ...
  geom_col(data = AcOnly_predictionSet,
             aes(x = date, y = obs_MC,color = Legend1),alpha = 1,width = .1,size = .25)+
  geom_line(data = AcOnly_predictionSet,
            aes(x=date, y=MC, color = Legend), size = .5) +
  geom_path(data = Joint_predictionSet,
            aes(x=date, y=MC),color = "red2", size = .5) +
  geom_path(data = VisOnly_predictionSet,
            aes(x=date, y=MC, color = LegendTest),size = .5) +
  labs(y = "", x = NULL)+coord_cartesian(ylim = c(0,45))+
  scale_color_manual(values= c("grey36","green3","deepskyblue"))+theme_bw()+
  theme(legend.position="none",axis.title.y = element_text(size = 8,),plot.margin = unit(c(0,0,10,9), "pt"),
...
p2 <- ggplot() +
  ...
  geom_line(data = AcOnly_predictionSet,
            aes(x=date, y=GC, color = Legend), size = .5) +
  geom_path(data = Joint_predictionSet,
...
p3 <- ggplot() +
  ...
  geom_line(data = AcOnly_predictionSet,
            aes(x=date, y=DT, color = Legend), size = .5) +
  geom_path(data = Joint_predictionSet,
            aes(x=date, y=DT),color = "red2", size = .5) +
  geom_path(data = VisOnly_predictionSet,
            aes(x=date, y=DT, color = LegendTest), size = .5) +
  scale_color_manual(values= c("grey36","green3","deepskyblue"))+
  labs(y =bquote("Density (per 1000"~km^2~")"), x = NULL)+theme_bw()+
coord_cartesian(ylim = c(0,120))+
  theme(legend.position="none",axis.title.y = element_text(size = 8,),plot.margin = unit(c(0,0,10,0), "pt"),axis.text.x = element_blank())+
  annotation_custom(dtLabel)
