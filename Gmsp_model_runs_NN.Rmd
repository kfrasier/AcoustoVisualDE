---
title: 'GoMx Pilot whale habitat models'
output: 
  html_document:
    toc: true
    toc_depth: 4
...
load('E:/NASData/ModelData/Gmsp/GmspMergedData.Rdata')
...
![](E:/NASData/ModelData/Gmsp/VisualOnly_Gmsp_missingData.png)
...
![](E:/NASData/ModelData/Gmsp/Gmsp_Timeseries_Site_MC.png)
![](E:/NASData/ModelData/Gmsp/Gmsp_Timeseries_Site_GC.png)
![](E:/NASData/ModelData/Gmsp/Gmsp_Timeseries_Site_DT.png)
![](E:/NASData/ModelData/Gmsp/Gmsp_Timeseries_Site_DC.png)
![](E:/NASData/ModelData/Gmsp/Gmsp_Timeseries_Site_MP.png)
<br> 
...
![](E:/NASData/ModelData/Gmsp/AcousticOnly_Gmsp_clevelandDots_noTransform.png)
...
![](E:/NASData/ModelData/Gmsp/VisualOnly_Gmsp_clevelandDots_noTransform.png)
...
![](E:/NASData/ModelData/Gmsp/Gmsp_correlations_noTransform.png)
...
![](E:/NASData/ModelData/Gmsp/AcousticAndVisual_Gmsp_clevelandDots_withTransform.png)
...
![](E:/NASData/ModelData/Gmsp/AcousticOnly_Gmsp_density_pres_abs.png)

<br>  
**Visual kernel densities:**

![](E:/NASData/ModelData/Gmsp/VisualOnly_Gmsp_density_pres_abs.png)
...
The visual data represent wether or not wilot whales were seen during each transect segment. The probability of missing a sighting of risso's dolphin was estimated as 
...
The acoustic data represent presence or absence of Risso's dolphin detections in one day bins. Given that a group of dolphins is present near the sensor, the probability of detecting them in a 5 minute period is estimated at 0.65, therefore the probability of missing is 1-0.65 = 0.35. Given that animals were present, the probability of missing a group for a full day is estimated as
...
![](E:/NASData/ModelData/Gmsp/GmspsightwTrunc_GU.png)
...
load("E:/NASData/ModelData/Gg/GgsightwTrunc_GU.Rdata")
...
![](E:/NASData/ModelData/Gg/Gg_exampleNetwork.png)
...
AcOnly_predictionSet$predSd_MC[m1] <- rowSds(as.matrix(predVar_MC_DF),na.rm=TRUE)
...
AcOnly_predictionSet$predSd_GC[m2] <- rowSds(as.matrix(predVar_GC_DF))
...
AcOnly_predictionSet$predSd_DT[m3] <- rowSds(as.matrix(predVar_DT_DF))
...
AcOnly_predictionSet$predSd_DC[m4] <- rowSds(as.matrix(predVar_DC_DF),na.rm=TRUE)
...
AcOnly_predictionSet$predSd_MP[m5] <- rowSds(as.matrix(predVar_MP_DF),na.rm=TRUE)
...
VisOnly_predictionSet$predSd_MC[m1] <- rowSds(as.matrix(predVar_MC_DF))
...
VisOnly_predictionSet$predSd_GC[m2] <- rowSds(as.matrix(predVar_GC_DF))
...
VisOnly_predictionSet$predSd_DT[m3] <- rowSds(as.matrix(predVar_DT_DF))
...
VisOnly_predictionSet$predSd_DC[m4] <- rowSds(as.matrix(predVar_DC_DF))
...
VisOnly_predictionSet$predSd_MP[m5] <- rowSds(as.matrix(predVar_MP_DF))
...
Joint_predictionSet$predSd_MC[m1] <- rowSds(as.matrix(predVar_MC_DF))
...
Joint_predictionSet$predSd_GC[m2] <- rowSds(as.matrix(predVar_GC_DF))
...
Joint_predictionSet$predSd_DT[m3] <- rowSds(as.matrix(predVar_DT_DF))
...
Joint_predictionSet$predSd_DC[m4] <- rowSds(as.matrix(predVar_DC_DF))
...
Joint_predictionSet$predSd_MP[m5] <- rowSds(as.matrix(predVar_MP_DF))
