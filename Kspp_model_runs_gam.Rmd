...
XEntropy$AcOnly_test_JointData <- LogLoss(round(pr$AcOnly_JointData$fit,
                                                         digits = 0),
                                                   as.vector(transformedCovars.test$y_TF))
XEntropy$VisOnly_test_JointData <- LogLoss(round(pr$VisOnly_JointData$fit,
                                                          digits = 0),
                                                   as.vector(transformedCovars.test$y_TF))
XEntropy$Joint_test <- LogLoss(round(pr$Joint_JointData$fit, digits = 0),
                                                   as.vector(transformedCovars.test$y_TF))
