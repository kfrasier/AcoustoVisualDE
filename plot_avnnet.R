plot.avnnet<-function(mod.in,nid=T,all.out=T,all.in=T,bias=T,wts.only=F,rel.rsc=5,circle.cex=5,
  ...
  if('train' %in% class(mod.in)){
    if('avNNet' %in% class(mod.in$finalModel)){
