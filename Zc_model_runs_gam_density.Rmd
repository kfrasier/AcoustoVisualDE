...
jan2009_VisOnly_prediction <- raster::predict(jan2009_rasters,VisOnly_model,
            type = 'response',na.action = na.pass)/10
jan2009_VisOnly_prediction_IncludingOutsideObs <- raster::predict(jan2009_rasters,VisOnly_model,
            type = 'response',na.action = na.pass)/10

july2009_VisOnly_prediction <- raster::predict(july2009_rasters,VisOnly_model,
            type = 'response',na.action = na.pass)/10
...
jan2009_prediction <- raster::predict(jan2009_rasters,Joint_model,
            type = 'response',na.action = na.pass,se.fit=TRUE)/10  

july2009_prediction <- raster::predict(july2009_rasters,Joint_model,
            type = 'response',na.action = na.pass,se.fit=TRUE)/10   
