---
title: 'GoMx Risso''s dolphin habitat models'
output: 
  html_document:
    toc: true
    toc_depth: 4
...
![](E:/NASData/ModelData/Gg/AcousticOnly_Gg_density_pres_abs.png)
...
The visual data represent wether or not Risso's dolphin were seen during each transect segment. The probability of missing a sighting of risso's dolphin was estimated as 
...
![](E:/NASData/ModelData/Gg/GgsightwTrunc_GU.png)
...
best_AcOnly_ModelIndex <-3
best_VisOnly_ModelIndex <-3
best_Joint_ModelIndex <-3
```
