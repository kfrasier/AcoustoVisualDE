...
jan2009_VisOnly_prediction <- raster::predict(jan2009_rastersVis,
         nn_VisOnly[[best_VisOnly_ModelIndex]],na.action = na.pass)*covars_Joint_max.train['y']
...
jan2009_prediction <- raster::predict(jan2009_rastersJoint,
         nn_Joint[[best_Joint_ModelIndex]],na.action = na.pass)*covars_Joint_max.train['y']
