...
p2 <- ggplot() +
  ...
  theme(legend.position="none", axis.title.y = element_text(size = 8,),panel.spacing.y=unit(0, "lines"),
        plot.margin = unit(c(0,0,10,7), "pt"),axis.text.x = element_blank())+
...
p3 <- ggplot() +
  ...
  theme(legend.position="none",axis.title.y = element_text(size = 8,),panel.spacing.y=unit(0, "lines"),plot.margin = unit(c(0,0,0,10), "pt"))+
