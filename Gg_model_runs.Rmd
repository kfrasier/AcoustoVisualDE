...
for (iM in 1:length(monthStr)){
  ...
  HYCOM_MLD_climate <- resample(raster(paste0(HYCOM_MLD_ClimateDir,'/',
                                        'proj_mld_month',
                                        monthNum[iM],'_mean.img')),predTemplate)
  raster_set[[iM]] <- brick(SST_climate,SSH_climate,CHL_climate,eddy_climate,HYCOM_MAG_climate,
                         HYCOM_SALIN_climate,HYCOM_MLD_climate) 
  names(raster_set[[iM]])<-c('SST','SSH','CHL','EddyDist','log10_HYCOM_MAG_0',
